...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/pig.png", __ASSET__assets_images_pig_png);
		type.set ("assets/images/pig.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_pig_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/pig.png") #if display private #end class __ASSET__assets_images_pig_png extends lime.graphics.Image {}
